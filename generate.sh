...
GENERATED="${GOPATH}/src/gitlab.com/tokene/lockton-one/rpc-wrapper-svc/resources"
OPENAPI_DIR="${GOPATH}/src/gitlab.com/tokene/lockton-one/rpc-wrapper-svc/docs/web_deploy"
